...
> = {
  ...
  primary: {
    outer: "bg-gradient-to-b from-[#562F00] to-[#FF9644]",
    inner: "bg-gradient-to-b from-[#FFCE99] via-[#562F00] to-[#FFFDF1]",
    button: "bg-gradient-to-b from-[#FF9644] to-[#562F00]",
    textColor: "text-[#FFFDF1]",
    textShadow: "[text-shadow:_0_-1px_0_rgb(86_47_0_/_100%)]",
  },
  success: {
  ...
  gold: {
    outer: "bg-gradient-to-b from-[#562F00] to-[#FFCE99]",
    inner: "bg-gradient-to-b from-[#FFFDF1] via-[#562F00] to-[#FFCE99]",
    button: "bg-gradient-to-b from-[#FFCE99] to-[#FF9644]",
    textColor: "text-[#562F00]",
    textShadow: "[text-shadow:_0_-1px_0_rgb(255_206_153_/_40%)]",
  },
  bronze: {
